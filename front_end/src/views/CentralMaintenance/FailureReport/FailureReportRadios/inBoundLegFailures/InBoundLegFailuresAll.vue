<template>
  <div>
    <el-table
      ...
      :data="InBoundLegFailuresAllArray"
...
export default {
  ...
  methods: {
    ...
    getInboundLegFailureAllArray() {
      ...
      let existingFailureParent = existingFailurefl_0.filter(
        (existingFailurefl_0) => existingFailurefl_0.is_parent == true
      );
      let existingFailureChild = existingFailurefl_0.filter(
        (existingFailurefl_0) => existingFailurefl_0.is_parent == false
      );
