<template>
  <div>
    ...
    <el-footer>
      <div>
        <button class="footer-btn" @click="saveSele()">PRINT</button>
      </div>
      <div>
        <button class="footer-btn" @click="clearSele()">FLIGHT LEGS</button>
        <button class="footer-btn" @click="startView">SELECT</button>
      </div>
    </el-footer>
  </div>
</template>
